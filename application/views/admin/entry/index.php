...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h5 class="panel-title"><i class="icon-pencil7"></i> Entri Data Kartu Keluarga</h5>
  </div>
          ...
          <?php $no=0; foreach($all as $row): $no++; ?>
            <tr>
                ...
                <td>
                  ...
                  <?php if($row->status==1){
                    echo "<span class='label label-success'> Data Aman</span>";
                    $site=site_url('entry/st1/'.$row->id_kk);
                    $teks="Nonaktifkan Data";
                    $icon="switch";
                    $class="warning";
                  }elseif($row->status==2){
                    echo "<span class='label label-warning'> Data Di Perbaiki</span>";
                    $site=site_url('entry/st2/'.$row->id_kk);
                    $teks="Aktifkan Data";
                    $icon="switch";
                    $class="default";
                  }?>
                ...
                <td>
                  <center>
                    ...
                    <a href="<?php echo site_url('entry/detailkk1/'.$row->id_kk); ?>"  class="btn btn-red btn-xs tooltips" data-popup="tooltip" data-original-title="Print" data-placement="top"><i class="icon-copy"></i></a>
