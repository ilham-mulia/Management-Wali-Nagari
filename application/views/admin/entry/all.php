        ...
        <tr>
          ...
          <td>
            <center>
              ...
              <a href="<?php echo site_url('entry/detailindividu1/'.$row->nik); ?>" class="btn btn-info btn-xs tooltips" data-popup="tooltip" data-original-title="Print" data-placement="top"><i class="icon-copy"></i></a>
            </center>
          </td>
        </tr>
      <?php endforeach; ?>
