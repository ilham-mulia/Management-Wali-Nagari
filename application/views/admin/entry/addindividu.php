...
<div class="panel panel-primary">
  ...
  <br>
  <div class="form-group">
    <label class='col-md-3'>Kategori / Pendidikan</label>
  <div class='col-md-9'>
    <?php
    include 'database.php';
    echo "
    <select data-placeholder='Pilih Kategori / Pendidikan Terakir' name='kategori' required class='select-clear'>
    <option></option>";
    $pil2=mysqli_query($koneksi,"select * from kategori");
    while($j=mysqli_fetch_array($pil2)){
    echo "<option value='$j[kategori]'>$j[kategori]</option>";
    }
    echo "</select>";
    ?>
  </div>
