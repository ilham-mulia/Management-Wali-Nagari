...
class Welcome extends CI_Controller {
	...
	public function logout()
	{
		...
		$this->session->set_flashdata('sukses', 'Anda Telah Keluar Dari Halaman Admin');
		redirect('login');
	}
	...
	public function backup(){
		...
		$aturan = array(
			'format' => 'zip',
			'filename' => 'mgwalinagori.sql',
		);
		$backup =& $this->dbutil->backup($aturan);

		$nama_database = 'backup-database-mgwalinagari-'. date("Y-m-d-H-i-s") .'.zip';
